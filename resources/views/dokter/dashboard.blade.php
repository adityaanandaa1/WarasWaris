        ...
        <form action="{{ route('dokter.update.jadwal') }}"  method="POST" class="dashboard-modal-form">
           ...
           <div class="form-group-date">
                <div class="date-picker">
                    <input type="text" id="dateInput" value="{{ $hari_ini->translatedFormat('d F Y') }}" class="date-input" readonly>
                    
                    <svg id="calendarIcon" width="23" height="22" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg" style="cursor: pointer;">
                ...
                <div class="calendar-popup hidden" id="calendarPopup">
                    <div class="dashboard-datepickercomponent">
                        ...
                        <div id="year" class="year hidden"></div>
                    </div>
                </div>
            </div>
